...
<head>
  ...
  <meta property="og:url" content="{{protocol}}://{{domain}}/fact?hash={{id}}"/>
...
<div class="center head">
  <div class="left">Fact #{{number}}</div>
...
<div class="center foot">
  <div class="social left">
    <fb:like href="{{protocol}}://{{domain}}/fact?hash={{id}}" layout="button_count" show_faces="true" width="100%" font=""></fb:like>
  </div>
  <div class="social right">
    <a href="http://twitter.com/share" class="twitter-share-button" data-text="{{short}} {{tweet_hash}}" data-url="{{protocol}}://{{domain}}/fact?hash={{id}}"  data-count="horizontal">Tweet</a>
  </div>
